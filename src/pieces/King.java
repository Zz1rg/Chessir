            ...
            if (col == 6) {
                ...
                if (rook != null && rook instanceof Rook && rook.isFirstMove) {
                    return board.getPiece(5, row) == null
                            ...
                            && !board.getCheckScanner().isKingChecked(new Move(board, this, 5, row), false)
                            && !board.getCheckScanner().isKingChecked(new Move(board, this, 4, row), false);
                }
            } else if (col == 2) {
                ...
                if (rook != null && rook instanceof Rook && rook.isFirstMove) {
                    return board.getPiece(1, row) == null
                            ...
                            && !board.getCheckScanner().isKingChecked(new Move(board, this, 3, row), false)
                            && !board.getCheckScanner().isKingChecked(new Move(board, this, 4, row), false);
                }
            }
        }
